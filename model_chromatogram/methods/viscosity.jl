...
function model(data::Matrix{Float64}, params::Vector{Float64})::Vector{Float64}
    ...
    return ρτ_component .+ χ_component_num ./ χ_component_den
end
...
function viscosity(solvent_model::String, T::Float_or_Vector, χ::Float_or_Vector, ρ::Float_or_Vector)::Float_or_Vector
