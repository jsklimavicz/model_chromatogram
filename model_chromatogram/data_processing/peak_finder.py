...
class PeakFinder:
    ...
    def __signal_smoothing(
        ...
        #         window_sizes[i] = min(window_sizes[i - 1] + 1.0, max_window)
        #     elif window_sizes[i] < window_sizes[i - 1] - 0.5:
        #         window_sizes[i] = max(window_sizes[i - 1] - 1.0, min_window)
        ...
        # # print(window_sizes[6200:6400:10])
        ...
        # print((s1 - smoothed_signal)[0::250])
        return s1
