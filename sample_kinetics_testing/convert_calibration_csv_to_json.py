...
output_file = "./sample_kinetics_testing/calibration_processing.json"
...
# Load the JSON file
with open("./sample_kinetics_testing/input_json/processing_methods.json", "r") as f:
    processing_methods = json.load(f)

# Load the CSV file
calibration_data = pd.read_csv("./sample_kinetics_testing/calibration.csv")
